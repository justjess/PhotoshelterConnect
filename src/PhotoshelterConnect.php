 ...
 * @since     1.0.0
 *
 * @property  PhotoshelterConnectService $photoshelterConnect
 * @property  Settings $settings
 * @method    Settings getSettings()
 */
class PhotoshelterConnect extends Plugin
{
    // Static Properties
    // =========================================================================
    ...
    public function init()
    {
        ...
        Event::on(
            ...
            function (Event $event) {
                ...
                $variable->set('photoshelterConnect', PhotoshelterConnectVariable::class);
            }
        );
